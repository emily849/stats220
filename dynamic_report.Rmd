...
The maximum length of an ad was `r max_ad_length` seconds, while the minimum length was `r min_ad_length` seconds, and the mean ad length was `r mean_ad_length` seconds. 
...
pie_meme <- image_read("https://i.imgflip.com/9h6h71.png") %>%
  image_scale(500)

uno_meme <- image_read("https://i.imgflip.com/9jeogi.jpg") %>% 
  image_scale(500)

meme_vector <- c(pie_meme, uno_meme)
image_append(meme_vector) %>% image_scale(500)
